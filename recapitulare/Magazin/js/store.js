...
const search = () =>{
    ...
    const storeitems = document.getElementById("productsJsonList");
    const product = document.querySelectorAll("productList");
    const pname = document.getElementById("title");
    
    for(var i = 0; i < pname.length; i++){
        let match = product[i].getElementsByTagName('title')[0];
